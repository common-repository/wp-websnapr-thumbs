=== WP Websnapr Thumbs ===
Contributors: dustypaws
Tags: websnapr, thumb, thumbnails
Requires at least: 1.5
Tested up to: 2.8.2
Stable tag: 0.0.1b

Easily add a website thumbnail to your post.

== Description ==

WP Websnapr Thumbs is the most easy way to decorate your postings with a nice snapshot.
...
1. Upload the 'wp-websnapr-thumb' folder to your plugins directory (wp-content/plugins/).
1. Activate the plugin through the 'plugins' page in WP.
1. No additional settings necessary.
...
1. Thumbnail that's aligned to the right
2. Thumbnail that's aligned to the left
